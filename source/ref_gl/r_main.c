...
qboolean			r_sunShadowsOn;
qboolean			r_nonSunStaticShadowsOn;
...
renderedmodels_t rendered_models[MAX_EDICTS+2*MAX_MAP_MODELS+MAX_ROCKS];
...
worldsurfuniforms_t worldsurf_uniforms[GLSL_MAX_DLIGHTS+1];
secondpassbspshadowuniforms_t secondpass_bsp_shadow_uniforms;
warpuniforms_t warp_uniforms;
rscriptuniforms_t rscript_uniforms[GLSL_MAX_DLIGHTS+1];
...
glassuniform_t glass_uniforms;
mesh_blank_uniform_location_t blankmesh_uniforms;
meshextractlightmapuniforms_t mesh_extract_lightmap_uniforms;
distortuniforms_t distort_uniforms;
scuniforms_t colorscale_uniforms, gaussian_uniforms, defringe_uniforms, kawase_uniforms;
esuniforms_t colorexp_uniforms;
...
vegetationuniforms_t vegetation_uniforms;
lensflareuniforms_t lensflare_uniforms;
qboolean is_localhost;
